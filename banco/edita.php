...
<html lang="pt-br">
    ...
    <body>
        ...
        <header>
            <img src="imagens/mariadb.png" width="20%" height="20%"/>
            <nav class="navbar navbar-expand-lg navbar-ligth bg-ligth">
                <div class="container-fluid">
                    <h3><b>Acesso a Banco de Dados</b></h3>
                        ...
                        <div class="card mb-2 rounded-2 shadow-sm">
                            ...
                            <div class="card-body text-left">
                               <?php
                                ...
                                $query = $conn->query($sql); //a mesma coisa que la no cad.php no local do if
                                while($dados = $query->fetch_assoc()){ //array associativo
                                    $nome = $dados['nome'];
                                    $idade = $dados['idade'];
                                }
                               ?>
